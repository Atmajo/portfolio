...
import next from "./components/logos/nextjs.png"
import react from "./components/logos/react.png"
import mongo from "./components/logos/mongo.png"
import js from "./components/logos/js.jpg"
import html from "./components/logos/html.png"
import git from "./components/logos/git.png"
import css from "./components/logos/css.png"
import c from "./components/logos/c.png"
import boot from "./components/logos/boot.png"
      ...
      <main className="select-none px-10 md:px-20 lg:px-40 dark:bg-gradient-to-b dark:from-slate-600 dark:to-slate-800  dark:text-white">
        ...
        <section>
          ...
          <div>
            ...
            <p className="text-center text-md py-2 text-gray-800 dark:text-white">What I use generally !</p>
            <div className="dark:bg-slate-750 text-left shadow-lg p-10 rounded-xl">
              <div className="flex justify-around py-10">
                <div className="w-20 h-20"><img src={next} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={react} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={mongo} alt="" draggable="false"/></div>
              </div>
              <div className="flex justify-around py-10">
                <div className="w-20 h-20"><img src={html} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={css} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={js} alt="" draggable="false"/></div>
              </div>
              <div className="flex justify-around py-10">
                <div className="w-20 h-20"><img src={git} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={c} alt="" draggable="false"/></div>
                <div className="w-20 h-20"><img src={boot} alt="" draggable="false"/></div>
              </div>
            </div>
          </div>
          <div>
            ...
            <div>
              <div className="flex justify-center gap-5">
                <div className=" py-5"><h3 className="text-2xl font-bold">2023</h3></div>
        ...
        <section>
          <footer className="py-5 text-center hover:drop-shadow-bglow dark:hover:drop-shadow-glow">
            <h3>Copyright ©️<span><a href="/">Atmajo Chowdhury</a></span></h3>
          </footer>
        </section>
      </main>
    </div>
